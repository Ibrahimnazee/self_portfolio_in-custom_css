      ...
      <section className="contact section" id="contact">
        ...
        <div className="contact_container container ">
            ...
            <div className="contact_info">
              <div className="contact_card" data-aos="fade-up" data-aos-delay="300">
                ...
                <span className="contact_card_data">
                     ibrahimnazeer410@gmail.com
                </span>

                <a
                  href="mailto:ibrahimnazeer410@gmail.com"
                  rel="noreferrer"
              ...
              <div className="contact_card" data-aos="fade-up" data-aos-delay="500">
                ...
                <span className="contact_card_data">+923128765615</span>

                <a
                  href="https://api.whatsapp.com/send?phone=03128765615"
                  rel="noreferrer"
                  className="contact_button"
                  target="_blank"
                >
              ...
              <div className="contact_card" data-aos="fade-up" data-aos-delay="700">
                ...
                <span className="contact_card_data">Ibrahim-Nazeer</span>

                <a
                  href="https://www.linkedin.com/in/ibrahim-nazeer-969514292/"
                  rel="noreferrer"
                  className="contact_button"
                  target="_blank"
                >
          ...
          <div className="contact_content">
            ...
            <form ref={form as any} onSubmit={sendEmail} className="contact_form">
