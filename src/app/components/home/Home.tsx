        ...
        -0.149132 97.9666 0.00163737C136.23 0.303176 174.193 10.857 190.312 36.4879Z"
          ...
          <div className="home_data">
            ...
            <p className="home_description" data-aos="zoom-in">
              I am a <b> Front-End developer </b> with a strong foundation in
              building responsive and user-friendly web applications. Proficient
              in HTML, CSS, JavaScript, and modern frontend frameworks like
              React, with experience in Tailwind CSS for styling.
            </p>
            <a
